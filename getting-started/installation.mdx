...
# For SentenceTransformer embeddings support
...
| Chunker | Default | embeddings | 'code' | 'all' |
|-------|:-------:|:----------:|:------:|:-------:|
| TokenChunker | ✅ | ✅ | ✅ |  ✅ |
| RecursiveChunker | ✅ | ✅ | ✅ |  ✅ |
| SentenceChunker | ✅ |  ✅ | ✅ | ✅ |
...
`CodeChunker` requires the `tree-sitter` and `tree-sitter-language-pack` libraries. You can install it with `pip install "chonkie[code]"`.
